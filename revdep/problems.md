...
*   checking tests ...
    ...
    Last 13 lines of output:
      1: av_get(symbol, av_fun) at testthat/test_av_get.R:22
      2: stop(content, call. = F)
      
      [31m2. Error: call Technical Indicators (@test_av_get.R#57) [39m------------------------
      Invalid API call. Please retry or visit the documentation (https://www.alphavantage.co/documentation/) for SMA.. API parameters used: symbol=MSFT, function=SMA, interval=monthly, time_period=60, series_type=close, apikey=HIDDEN_FOR_YOUR_SAFETY
      ...
      2. Error: call Technical Indicators (@test_av_get.R#57) 
