...
This is a convenient shortcut for attaching the cores packages, produces a short report that gives the package versions you're using, and succintly informs you of any conflicts with packages you've previously loaded. As of tidyverse version 1.2.0, the core packages include dplyr [@R-dplyr], forcats [@R-forcats], ggplot2 [@ggplot2], purrr [@R-purrr], readr [@R-readr], stringr [@R-stringr], tibble [@R-tibble], and tidyr [@R-tidyr]. 
