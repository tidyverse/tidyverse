...
There are four basic principles behind a tidy API (further expanded upon in [The
tidy tools
manifesto](https://tidyverse.tidyverse.org/articles/manifesto.html))[@tidy-tools-manifesto]:

1.  Reuse existing data structures.

2.  Compose simple functions with the pipe.[@Bache2014]
...
<!----- I want to say something here like: by using a consistent data structure, you can use simple functions. The pipe makes things readable, which means you're designing for humans. And, umm, embrace functional programming full-stop ----->
